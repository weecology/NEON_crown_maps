...
def shapefile_to_annotations(shapefile, rgb, savedir="."):
    ...
    try:
        ...
        raise EnvironmentError("Geopandas not installed by default, as it is only used for this utility. See geopandas installation: http://geopandas.org/install.html ")    
