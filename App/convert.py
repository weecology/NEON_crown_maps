...
if __name__=="__main__":  
  ...
  client = start_cluster.start(cpus=10,mem_size="50GB")
  ...
  #just run OSBS
  df = df[df.site.isin(["BONA","CLBJ","DEJU","DELA","DSNY","HARV","JERC","KONZ","LAJA","MOAB","NIWO","OAES","SOAP","SRER","TALL","TEAK","WOOD","WREF"])]
