...
sudo docker run -it --rm -d -p 8080:80 -v /datadrive/OpenVisus/:/converted -v /home/bweinstein/NEON_crown_maps/App/config.js:/home/OpenVisus/dataportal/ext/visus/config.js visus/dataportal
