...
rect_subset <- rects %>% filter(site %in% c("DSNY","TEAK","OSBS","BART","DELA","SJER","UKFS","WREF","LENO"))
sampling %>% filter(site %in% c("DSNY","TEAK","OSBS","BART","DELA","SJER","UKFS","WREF","LENO")) %>% ggplot(.) + 
